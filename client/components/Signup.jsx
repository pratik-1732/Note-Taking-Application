        ...
        <div className="content p-16">
          ...
          <form className="mt-4">
            <div className="flex flex-col mb-2">
              ...
              <input
                type="text"
                className="w-full outline-blue-500 h-12 px-4 py-3 border border-[#969696] rounded-md text-lg font-normal text-black"
            ...
            <div className="flex flex-col mb-2">
              ...
              <div className="flex gap-2 items-center w-full h-12  border border-[#969696] rounded-md ">
                <Calendar className=" text-gray-400 w-5 h-5 ml-2 cursor-pointer" />
                <input
                  type="text"
                  className="w-full text-lg font-normal text-black outline-blue-500"
                  placeholder="date"
                />
              </div>
            </div>
